...
window.ulanziLocalStorage = createStorage({ prefixKey: UlanzideckPluginUUID, storage: localStorage });

window.setUlanziGlobalSettings = function(settings) {
    window.ulanziLocalStorage.set(GLOBAL_SETTINGS_KEY, JSON.stringify(settings));
}

window.getUlanziGlobalSettings = function() {
    const settingsStr = window.ulanziLocalStorage.get(GLOBAL_SETTINGS_KEY);
    return JSON.parse(settingsStr);
}

window.removeUlanziGlobalSettings = function() {
